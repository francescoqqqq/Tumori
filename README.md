# BraTS 2023 Hybrid Dataset for Loss Function Benchmarking

Questo progetto prepara un dataset ibrido (Reale + Sintetico) per testare e confrontare diverse Loss Function (Dice, HD, clDice) su nnU-Net.
